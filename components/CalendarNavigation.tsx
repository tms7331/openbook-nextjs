  ...
  return (
    <div className='flex items-center justify-between p-4 border-b border-purple-200 bg-gradient-to-r from-purple-50 to-white'>
      <div className='flex items-center gap-3'>
        ...
        <h1 className='text-lg font-semibold text-purple-900 text-center'>
        ...
        <Button
          onClick={() => navigateDate(1)}
          size='icon'
          className='bg-purple-600 hover:bg-purple-700 mr-2 text-white rounded-full shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5'
        >
      ...
      >
        {!isToday && <CalendarDays className='w-4 h-4 mr-2' />}
